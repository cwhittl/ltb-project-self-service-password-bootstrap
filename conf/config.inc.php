...
# Send SMS mail to address use this if everyone has the same service provider
$smsmailto = "";
#$smsmailto = "{sms_attribute}@service.provider.com";

# Carrier Options - Use this is everyone has different carriers
$sms_carrier_options = array(
 "txt.att.net" => 'AT&T',
...
$recaptcha_theme_template = <<<CUSTOM_T
        <!-- Start Responsive reCAPTCHA Here -->

  <div id="recaptcha_widget" style="display:none" class="recaptcha_widget">
    <div id="recaptcha_image"></div>
    <div class="recaptcha_only_if_incorrect_sol" style="color:red">Incorrect. Please try again.</div>

    <div class="recaptcha_input alert-warning">
    ...
    <ul class="recaptcha_options">
      ...
      <li class="recaptcha_only_if_image">
        <a href="javascript:Recaptcha.switch_type('audio')">
          <i class="glyphicon glyphicon-volume-down"></i><span class="captcha_hide"> Get an audio CAPTCHA</span>
        </a>
      </li>
