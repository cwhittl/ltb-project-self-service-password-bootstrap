...
<form action="#" method="post">
    ...
    <input class="form-control" placeholder="<?php echo $messages["password"]; ?>" type="password" name="password" />
     <div class="row"><label><?php echo $messages["question"]; ?></label></div>
...
?>
    ...
    <input class="form-control" placeholder="<?php echo $messages["answer"]; ?>" type="text" name="answer" />
<?php if ($use_recaptcha) { ?>
    <div class="row text-center">
<?php echo selfservice_recaptha_get_html($recaptcha_publickey, null, $recaptcha_ssl,$recaptcha_theme,$lang); ?>
    </div>
<?php } ?>
    <input class="btn btn-lg btn-primary btn-block" type="submit" value="<?php echo $messages['submit']; ?>" />
</form>
