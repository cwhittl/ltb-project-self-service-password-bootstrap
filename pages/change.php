...
<div class="result alert alert-<?php
    ...
    if ($show_help) {
        ...
        if ($use_questions or $use_tokens or $use_sms) {
            echo '<div class="container">
                <div class="btn-group"> 
                    <a class="btn dropdown-toggle btn-warning" data-toggle="dropdown" href="#">' . $messages["changehelpreset"] . '
...
<form action="#" method="post" class="form-horizontal">
    ...
    echo $messages["login"]; ?>" type="text" name="login" value="<?php
    echo htmlentities($login) ?>" /></td></tr>
    <input class="form-control" placeholder="<?php
    echo $messages["oldpassword"]; ?>" type="password" name="oldpassword" />
    <input class="form-control" placeholder="<?php
    echo $messages["newpassword"]; ?>" type="password" name="newpassword" />
    <input class="form-control" placeholder="<?php
    echo $messages["confirmpassword"]; ?>" type="password" name="confirmpassword" />
<?php
    if ($use_recaptcha) { ?>
    <div class="row">
<?php
        echo selfservice_recaptha_get_html($recaptcha_publickey, null, $recaptcha_ssl, $recaptcha_theme, $lang); ?>
    </div>
<?php
    } ?>
    <input class="btn btn-lg btn-primary btn-block" type="submit" value="<?php
    echo $messages['submit']; ?>" /></td></tr>
</form>
